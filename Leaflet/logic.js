...
for (var i = 0; i < response.features.length; i++) {
  L.circle([location.coordinates[1], location.coordinates[0]], {
    ...
    radius: markerSize(response.features[i].properties.mag*400)
  }).bindPopup("<h1>" + response.features[i].properties.mag + "</h1> <hr> <h3>Population: " + cities[i].population + "</h3>").addTo(myMap);
}
  //===============================Bubbles=================================================
